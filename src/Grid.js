...
class Grid extends Component {
  ...
  render() {
    ...
    <div style={{margin: '5px'}}>
      ...
      <p>This is an app created by the composer David Pocknee in 2018 to help him finish composing his guitar piece <i>Every</i>, which he wrote between 2013 and 2018.  <i>Every</i> is around 10 minutes in length and is "a compendium of 
 almost every playable guitar chord of 1-6 notes solely containing the note E and consisting only of fingered pitches or natural harmonics (up to the 5th partial)".</p>
      ...
      <p>After you have decided upon an order of chords that you like, the order can be converted into musical notation in the liypond format by using the controls at the bottom right of the window.</p>
